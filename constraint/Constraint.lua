...
function Constraint.create(options)
	...
	local initialPointA = constraint.bodyA and Vector.add(constraint.bodyA.position, constraint.pointA)
		or constraint.pointA
	local initialPointB = constraint.bodyB and Vector.add(constraint.bodyB.position, constraint.pointB)
		or constraint.pointB
...
function Constraint.solve(constraint, timeScale)
	...
	local torque, share, normal, normalVelocity, relativeVelocity
